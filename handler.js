...
`.trim(), m.message, {
    ...
    async onCall(json) {
        ...
        await this.sendMessage(from, 'NGAPAIN NELFON BOT!? LU MAU SAYA BLOKIR 🤨!!', MessageType.extendedText)
